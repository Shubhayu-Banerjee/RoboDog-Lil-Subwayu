# Lil-Subwayu: Quadruped Robot Motion Solver

The files in this repository solve the Inverse Kinematics and Motion Gait Generation for a basic quadruped robot dog.

# Single Leg Inverse Kinematics

A single leg is the standard dog leg, containing 2 joins, one at the hip and knee. And a 3rd join that rolls the entire leg.

- Single Leg IK Calc.py calculates raw angles (for 3 dimensions).
- Single Leg IK Visualiser 2D.py is a 2D Visualiser.
- Single Leg IK Visualiser 3D.py is a 3D visualiser adding in the Roll control for the leg.
